/*
* audiofile.cc JavaScript Library v0.1.6
* https://audiofile.cc/
* 
...
function drawClefs() {
// I am mixing the code for the bass and treble clefs because when the circle
...
// and seperate this out into two functions called bassClef() and trebleClef()
  ...
  $("div[data-measure]").each(function(index) {
    ...
    $(this).find("div[data-note]").each(function(index) {
      ...
      if ($(this).hasClass("sharp")) {
        var isSharp = "true";
        console.log('has sharp here: ' + noteLength);
...
//clearCanvas() isn't working right now. The plan is to create an api around
